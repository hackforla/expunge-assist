...
const Step3: React.FC<StepProps> = ({ inputs, setInputs }) => {
  ...
  return (
    <div className="Step3">
      ...
      <p>What is the name of the community service organization that you are involved with?</p>
      <input type='text' name='communityServiceOrgName' onChange={handleChange} />
      <p>Please describe what you do at this community service organization (2 sentences maximum)</p>
      <input type='text' name='communityServiceDescription' onChange={handleChange} />
      ...
      <p>Please describe what you do at your current job. (2 sentences maximum)</p>
