...
export const FORM_STEPS = {
  ...
  INVOLVEMENT: {
    INITIAL: 'FORM_STEPS.INVOLVEMENT.INITIAL',
...
export const PAGES = {
  ...
  [FORM_STEPS.INVOLVEMENT.INITIAL]: 'involvement/initial',
  [FORM_STEPS.INVOLVEMENT.JOB]: 'involvement/job',
  [FORM_STEPS.INVOLVEMENT.RECOVERY]: 'involvement/recovery',
  [FORM_STEPS.INVOLVEMENT.SCHOOL]: 'involvement/school',
  [FORM_STEPS.INVOLVEMENT.PARENTING]: 'involvement/parenting',
  [FORM_STEPS.INVOLVEMENT.UNEMPLOYED]: 'involvement/unemployed',
...
export function getNextFormStep(step: string) {
  switch (step) {
    ...
    case FORM_STEPS.INTRODUCTION:
      return FORM_STEPS.INVOLVEMENT.INITIAL;
