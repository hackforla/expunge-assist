...
describe("Button component", () => {
    ...
    test('Button click triggers onClick function', () => {
        ...
        const { getByText } = render(<ButtonComponent buttonText="Click Me" onClick={mockOnClick} />);
    ...
    test('Button renders back arrow', () => {
        const { getByText, getByTestId } = render(<ButtonComponent buttonText="Back" hasBackArrow />);
    ...
    test('Button renders forward arrow', () => {
        const { getByText, getByTestId } = render(<ButtonComponent buttonText="Next" hasForwardArrow />);
    ...
    test('Button is disabled when disabled prop is true', () => {
        const { getByRole } = render(<ButtonComponent buttonText="Disabled Button" disabled={true} />);
    ...
    test('Button is re-enabled when disabled prop is false', () => {
        const { getByRole } = render(<ButtonComponent buttonText="Enabled Button" disabled={false} />);
